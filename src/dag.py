...
def postgres_to_snowflake_etl():
    ...
    for table_name in table_names:
        ...
        def get_max_primary_key(table_name: str):
            """Essa função ira receber como argumento o nome da tabela e irá retornar o maior ID encontrado ne mesma"""
        ...
        def load_incremental_data(table_name: str, max_id: int):
            """Essa função ira receber como argumento o nome da tabela e maior ID encontrado na tebela e irá inserir os valores 
            cadastrados a partir do ID encontrado, de forma incremental"""
